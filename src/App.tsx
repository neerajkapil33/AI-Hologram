...
function App() {
  ...
  return <main className="neeraj-screen">
    <style>{`.header-center{position:absolute;left:50%;top:50%;transform:translate(-50%,-50%);width:min(58vw,680px);text-align:center;pointer-events:none;display:flex;flex-direction:column;align-items:center;justify-content:center;line-height:1}.header-neeraj{font-size:24px;font-weight:900;letter-spacing:9px;padding-left:9px;color:#f2fcff;text-shadow:0 0 18px rgba(81,221,255,.28)}.header-sub{margin-top:7px;font-size:8px;font-weight:700;letter-spacing:2.2px;color:#51ddff;text-transform:uppercase}.header-status{display:flex;align-items:center;gap:7px;margin-top:8px;font-size:7px;font-weight:800;letter-spacing:1.4px;color:#20ff92;text-transform:uppercase}.header-status i{display:block;width:6px;height:6px;border-radius:50%;background:#20ff92;box-shadow:0 0 12px #20ff92}.neeraj-header .system-pill{flex-shrink:0}@media(max-width:820px){.header-center{position:relative;left:auto;top:auto;transform:none;width:auto;flex:1;min-width:0;margin:0 8px}.header-neeraj{font-size:18px;letter-spacing:6px;padding-left:6px}.header-sub{font-size:5.5px;letter-spacing:1px;margin-top:5px}.header-status{font-size:5.5px;letter-spacing:.7px;margin-top:5px}.neeraj-header .brand-lockup{flex-shrink:0}}`}</style>
    <canvas ref={ref} className="hologram-canvas" /><div className="screen-grid" />
    <header className="neeraj-header"><div className="brand-lockup"><div className="brand-orb">N</div><div><div className="brand-name">NEERAJ <span>AI</span></div><div className="brand-line">Career. Growth. Global.</div></div></div><div className="header-center"><div className="header-neeraj">NEERAJ</div><div className="header-sub">REAL-TIME 3D AVATAR • CAREER INTELLIGENCE</div><div className="header-status"><i /> ONLINE • REAL NEERAJ 3D READY</div></div><div className="system-pill"><i /> ONLINE <b>│</b> WEBGPU <b>│</b> TYPEGPU <b>│</b> REACT</div></header>
